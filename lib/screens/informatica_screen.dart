...
class InformaticaScreen extends StatelessWidget {
      ...
      drawer: const Menu(), 
            ...
            const Image(
              image: NetworkImage('https://www.umayor.cl/um/bundles/carreras/images/carreras/santiago/ingenieria-civil-informatica.jpg')
            ),
						...
						Container(
							...
							child: const Row(								
								children: [
									Column(
										children: [
											HomeTile(icon: Icons.grade_outlined, title: 'Titulo Profesional', description: 'Ingeniero(a) en Computación'),
									...
									Column(
										children: [
											HomeTile(icon: Icons.library_books_outlined, title: 'Grado Academico', description: 'Licenciado(a) en Ciencias'),
