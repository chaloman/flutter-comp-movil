...
class EnfermeriaScreen extends StatelessWidget {
  	const EnfermeriaScreen({super.key});	
      ...
      drawer: const Menu(), 
            ...
            const Image(
					    image: NetworkImage('https://www.umayor.cl//um/bundles/carreras/images/carreras/santiago/enfermeria.jpg')
				    ),
						...
						Container(
							...
							child: const Row(								
								children: [
									Column(
										children: [
											HomeTile(icon: Icons.grade_outlined, title: 'Titulo Profesional', description: 'Enfermera(o)'),
									...
									Column(
										children: [
											HomeTile(icon: Icons.library_books_outlined, title: 'Grado Academico', description: 'Licenciado(a) en Enfermería'),
											HomeTile(icon: Icons.calendar_today_outlined, title: 'Duración', description: 'Once semestres'),
											HomeTile(icon: Icons.grade_outlined, title: 'Decano(a) Interino(a)', description: 'Maria Cecilia Latrach Ammar'),
										],
									),
								],
							)
